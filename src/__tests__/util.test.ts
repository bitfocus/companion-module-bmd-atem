...
test('formatAudioRoutingAsString', () => {
	...
	expect(formatAudioRoutingAsString(sourceId)).toEqual('1234:5/6')

	const sourceId2 = combineInputId(9999, AudioChannelPair.Channel11_12)
	expect(formatAudioRoutingAsString(sourceId2)).toEqual('9999:11/12')

	const sourceId3 = combineInputId(0, AudioChannelPair.Channel5_6)
	expect(formatAudioRoutingAsString(sourceId3)).toEqual('0:5/6')
})

describe('parseAudioRoutingString', () => {
	test('single', () => {
		const parse1 = parseAudioRoutingString('9991:1/2')
	...
	test('multiple', () => {
		const parse1 = parseAudioRoutingString('9991:1/2,123 456, ,777:5/6')
...
test('parseAudioRoutingStringSingle', () => {
	const parse1 = parseAudioRoutingStringSingle('9991:1/2')
	expect(parse1).toEqual(combineInputId(9991, AudioChannelPair.Channel1_2))

	const parse2 = parseAudioRoutingStringSingle('9291:7/8')
	expect(parse2).toEqual(combineInputId(9291, AudioChannelPair.Channel7_8))

	const parse3 = parseAudioRoutingStringSingle('9291-7/8')
	...
	const parse5 = parseAudioRoutingStringSingle('9291:8/9')
